...
const cardData = [
  {
    ...
    description:
      "Capture seus pensamentos, aprendizados e insights de forma organizada e estruturada.",
    ...
    icon: (
      ...
      >
        ...
        <path
          d="M12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2ZM12 4C16.4183 4 20 7.58172 20 12C20 16.4183 16.4183 20 12 20C7.58172 20 4 16.4183 4 12C4 7.58172 7.58172 4 12 4ZM10 8H14M10 12H14M10 16H14"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
  ...
  },
  {
    ...
    description:
      "Registre suas emoções e identifique padrões ao longo do tempo para melhor autoconhecimento.",
  ...
  },
  {
    ...
    description:
      "Gráficos intuitivos mostram sua evolução e padrões de comportamento ao longo do semestre.",
  ...
  },
  {
    ...
    description:
      "Design limpo e moderno que facilita seu fluxo de registros e consultas.",
    colors: iconColors.blue,
    icon: (
      <svg
        className="w-6 h-6"
  ...
  },
  {
    ...
    description:
      "Seus registros são privados e protegidos com boas práticas de segurança.",
    colors: iconColors.purple,
    icon: (
      <svg
        className="w-6 h-6"
  ...
  },
  {
    ...
    description:
      "Desenvolva maior consciência sobre seus padrões e comportamentos ao longo do tempo.",
    colors: iconColors.green,
    icon: (
      <svg
        className="w-6 h-6"
      ...
      >
        ...
        <path
          d="M6 15V19C6 19.5523 6.44772 20 7 20H17C17.5523 20 18 19.5523 18 19V15M6 9V5C6 4.44772 6.44772 4 7 4H17C17.5523 4 18 4.44772 18 5V9M10 12L8 14M14 12L16 14M14 12L16 10M10 12L8 10"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  return (
    <section className=" pt-12 pb-16 text-gray-800">
      <div className="max-w-6xl mx-auto px-6">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-center text-foreground">
          Por que usar MindTrack?
        </h2>
        <p className="mt-2 text-center text-gray-500 max-w-2xl mx-auto">
          Uma plataforma completa para sua jornada de autoconhecimento e
        ...
        <div className=" mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {cardData.map((card, index) => (
            <article
              key={index}
              className=" cursor-pointer flex items-start gap-4 p-8 bg-white rounded-xl shadow-sm border border-transparent hover:shadow-md transition"
            >
              <div className={`flex-none ${card.colors.bg} rounded-lg p-3`}>
                <div className={card.colors.text}>{card.icon}</div>
              </div>
              <div>
                <h3 className="font-semibold text-gray-900">{card.title}</h3>
                <p className="mt-1 text-gray-500 text-sm">{card.description}</p>
              </div>
            </article>
          ))}
        </div>
