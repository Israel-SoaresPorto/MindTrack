...
const StepCard: React.FC<StepCardProps> = ({
  ...
  return (
    <div className="flex flex-col items-center text-center p-6 w-full md:w-1/3 flex-1 min-h-[260px] bg-white rounded-2xl shadow-sm hover:shadow-md transition-transform duration-300 ease-in-out transform hover:-translate-y-2">
      {/* Círculo do Ícone */}
      <div
        className={`w-14 h-14 rounded-full flex items-center justify-center text-xl font-bold mb-4 ${iconBgClass} ${iconTextClass} ring-4 ring-white shadow-md transition duration-300 ease-in-out`}
      >
        {step}
      </div>
  ...
  const steps = [
    {
      ...
      description:
        "Cadastre-se com seu e-mail e crie uma senha segura em menos de um minuto.",
    ...
    },
    {
      ...
      description:
        "Comece a registrar suas reflexões, emoções e aprendizados diariamente.",
    ...
    },
    {
      ...
      description:
        "Visualize gráficos e análises que mostram sua evolução ao longo do tempo.",
